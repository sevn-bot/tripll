...
from tripll.plan.cw_buckets import LEGACY_CW_BUCKETS, default_cw_hotspots


@pytest.mark.tier1
@pytest.mark.xfail(reason="green after W8: default hotspots empty for non-sevn repos", strict=False)
...
@pytest.mark.tier1
@pytest.mark.xfail(reason="green after W8: no sevn forbidden paths for foreign repo", strict=False)
...
@pytest.mark.tier1
@pytest.mark.xfail(reason="green after W8: CW_HOTSPOTS defaults empty at import", strict=False)
